...
const proceduralAssets: AssetDefinition[] = [
  ...
  },
  {
    ...
    license: "DnDRom",
    parts: [
      ...Array.from({ length: 8 }, (_, index) => part("box", { x: 0, y: .3, z: -1.75 + index * .5 }, { x: 3.2, y: .18, z: .43 }, index % 2 ? "#725038" : "#825e3d", undefined, undefined, "wood")),
      part("box", { x: -1.48, y: .72, z: 0 }, { x: .16, y: .15, z: 4 }, "#59402b", undefined, undefined, "wood"),
      part("box", { x: 1.48, y: .72, z: 0 }, { x: .16, y: .15, z: 4 }, "#59402b", undefined, undefined, "wood"),
      part("box", { x: -1.48, y: .43, z: -1.7 }, { x: .18, y: .85, z: .18 }, "#4b3525", undefined, undefined, "wood"),
      part("box", { x: 1.48, y: .43, z: -1.7 }, { x: .18, y: .85, z: .18 }, "#4b3525", undefined, undefined, "wood"),
      part("box", { x: -1.48, y: .43, z: 1.7 }, { x: .18, y: .85, z: .18 }, "#4b3525", undefined, undefined, "wood"),
      part("box", { x: 1.48, y: .43, z: 1.7 }, { x: .18, y: .85, z: .18 }, "#4b3525", undefined, undefined, "wood"),
    ],
